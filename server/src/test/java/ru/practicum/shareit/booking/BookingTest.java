...
public class BookingTest {
    ...
    void testAllArgsConstructor() {
        ...
        Item item = new Item();
        User user = new User();
        Booking booking = new Booking(1L, start, end, item, user, Statuses.APPROVED);
    ...
    @Test
    void testToString() {
        Booking booking = new Booking(1L, LocalDateTime.now(), LocalDateTime.now().plusDays(1), null, null, Statuses.APPROVED);
