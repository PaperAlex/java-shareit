...
class ItemRequestControllerTest {
    ...
    private final ItemRequestDtoOut requestDto = new ItemRequestDtoOut(1L, "description", 2L,
            LocalDateTime.of(2025, 6, 1, 12, 12, 12));

    @Test
    void createRequest() throws Exception {
        when(requestService.create(any(), anyLong())).thenReturn(requestDto);
